...
import { 
  ...
  Camera, Lock, Mail, PlayCircle, Layers
} from 'lucide-react';
...
// 1. Arranca la App con tus credenciales
const app = initializeApp(firebaseConfig);

// 2. Prepara la autenticación y la base de datos para usarlas
const auth = getAuth(app);
const db = getFirestore(app);

// 3. Define el ID para guardar tus datos (esto es vital para que no se mezclen)
